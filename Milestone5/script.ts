...
downloadPdfButton.addEventListener('click', () => { 
    window.print(); 
    // This will open the print dialog and allow the user to sav as PDF 
}); 
...
window.addEventListener('DOMContentLoaded', () => { 
    ...
    if (username) {
        ...
        if (savedResumeData) { 
            ...
            (document.getElementById('experience') as HTMLTextAreaElement).value = resumeData.experiencce; 
